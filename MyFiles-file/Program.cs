...
namespace MyFiles_file
{
    class Program
    {
        ...
        {
            string sourceFilePath = $@"C:\Users\opilane\samples\MyFiles-file.txt";
        ...
        {
            string sourceFilePath = $@"\Users\opilane\samples\LogITpe21\MyFiles-file.txt";
